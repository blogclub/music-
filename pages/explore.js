  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [
          responseTags,
          responseHighQualityPlaylists,
          responseNewSongs,
          responseNewAl,
          responseNewMV,
          responseNewAr,
        ] = await Promise.all([
          fetch(`${site.api}/playlist/highquality/tags`),
          fetch(`${site.api}/personalized`),
          fetch(`${site.api}/personalized/newsong`),
          fetch(`${site.api}/album/newest`),
          fetch(`${site.api}/personalized/mv`),
          fetch(`${site.api}/top/artists`),
        ]);
    ...
    <Container title="探索">
      ...
      {playlists.length && (
        <>
          ...
          {selectedTag !== "" && (
            <Display source={tagedPlaylist} type="playlist" />
          )}
          <br />
          <br />
        </>
